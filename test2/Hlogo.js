...
//constructor(){this.xs=0;this.ys=0;this.xf=0;this.yf=0;this.angle=0;}
  ...
  fd(can,len) {this.xf=this.xs+len*Math.cos(Math.PI*this.angle/180)
  this.yf=this.ys+len*Math.sin(Math.PI*this.angle/180)
  can.moveTo(this.xs,this.ys);can.lineTo(this.xf,this.yf);
  can.stroke();
  this.xs=this.xf;this.ys=this.yf;
  }

 bk(can,len) {this.xf=this.xs-len*Math.cos(Math.PI*this.angle/180)
  this.yf=this.ys-len*Math.sin(Math.PI*this.angle/180)
  can.moveTo(this.xs,this.ys);can.lineTo(this.xf,this.yf);
  can.stroke();
  this.xs=this.xf;this.ys=this.yf;
